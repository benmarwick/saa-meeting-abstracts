...
LW: We compared the word frequencies between two time periods, before 2004 and after 2004, to explore the general change of the usage of words in archaeology over time. We observed (Figure XX) an interesting pattern that shows a considerable high proportion of words used less often compared to words used more often after 2004, despite the word count is much higher in the later time. That is, archaeologists in more recent years have a smaller range of word choices and tend to not use some words, such as prehistoric, data, site, settlement, and patterns, used frequently in the past. In contrast, the words such as landscape, ancient, social, practices, and understanding become common after 2004. It could reflect an extinction of a large group of words during the course of the development of archaeology. One reason may be researchers have a more common idea about the selection of words when the community becomes bigger and more international. This leads to the use of a smaller group of words that present the sharing understanding about archaeology instead of the use of large group of obscure words demonstrate one's knowledge. 
