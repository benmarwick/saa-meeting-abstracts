...
LW: We trained the word embeddings on the co-occurrence matrix by GloVe model using the text2vec package [@Selivanov2016]. GloVe (Global Vectors) is a learning model trained on global information, in our case is the co-occurrence matrix from abtract corpus, to capture word vectors, a group of words, as a representation of a target word. The underlying principle is that GloVe algorithm converts co-occurrence counts to probabilities ratios for words of interest. 
